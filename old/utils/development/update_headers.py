...
"""
Tools to update the license/version header text in all scripts
"""
...
license_txt = """\
(*)~---------------------------------------------------------------------------
Copyright (C) 2011-2017  Jeff MacInnes
...
excludes = [ '.gitignore', 'update_headers.py']
...
def get_files(start_dir, includes, excludes):
    # use os.walk to recursively dig down into the Pyneal directory
    match_files = []
...
if __name__ == '__main__':
    ...
    # find out the cwd and change to the top level Pyneal folder
    cwd = os.getcwd()
    pyneal_dir = cwd
