""" Set of classes and methods specific to GE Multiband scanning environments

This is almost identical to the standard GE_utils.py tools, with the exception that
the number of slices are obtained from the dicom private tag [Locations in acquisition](0021, 104f)
instead of standard tag 'ImagesInAcquisition'. This change is based on sample GE multiband data
obtained at Duke BIAC
...
class GE_BuildNifti():
    ...
    def buildAnat(self, dicomFiles):
        ...
        self.nSlicesPerVol = dcm[locInAcqTag].value
...
class GE_processSlice(Thread):
    ...
    def processFirstSlice(self, dcm_fname):
        ...
        self.nSlicesPerVol = dcmHdr[locInAcqTag].value
